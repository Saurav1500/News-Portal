...
@section('title', 'नयाँ भूमिका - News AI')
@section('content')
<div class="dashboard-content">
    <div class="page-header">
        <div class="header-top">
            <div>
                <h1 class="page-title">नयाँ भूमिका</h1>
                <p class="page-subtitle">नयाँ भूमिका सिर्जना गर्नुहोस्</p>
            </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-actions full-width">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> भूमिका सिर्जना गर्नुहोस्
                    </button>
                </div>
            </div>
        </form>
